...
the information found in its Compilation Unit (CU) because it can not see the body
content of functions in other files of the project. A CU is the
...
There is also works using a profile-based approach rather than a whole-program
